export const useTodoActions = ({
  ...
  const onReorder = async (activeId, overId) => {
    ...
    try {
      ...
      const [moveTodo] = newTodos.splice(activeIndex, 1);
      newTodos.splice(overIndex, 0, moveTodo);
  ...
  return {onAdd, handleUpdate, toggleComplete, handleDelete, handleDeleteCompleted, confirmDeleteCompleted, onReorder, hasCompletedTodos};
};