const DeleteConfirmModal = ({onCancel, onConfirm, message, deletingId, isDeletingCompleted}) => {
    ...
    <>
      <div className="fixed inset-0">
        ...
        <div className="relative flex h-full items-center justify-center p-4 z-5">
          ...
          mx-4 bg-white text-gray-800 dark:bg-gray-800 dark:text-white">
            ...
            <div className="flex justify-end gap-3">
              ...
              dark:bg-gray-600 dark:hover:bg-gray-700 transition-colors cursor-pointer">Отмена</button>
              <button onClick={onConfirm} className="px-4 py-2 bg-red-500 text-white rounded 
              hover:bg-red-600 transition-colors cursor-pointer">Удалить</button>
            </div>
          </div>
        </div>
      </div>
